...
Activity fueling is reported separately from the regular diet under "Activity fueling". Do NOT critique its macro composition (high sugar, low protein, low fiber are expected and correct mid-effort) and do not include fueling carbs/calories in macro-quality assessments or "imbalanced sugar" calls. When evaluating fueling, use a target of ~60 g/hr for moderate, 80–100 g/hr for hard >2 hr, 90–120 g/hr for race-pace efforts >2.5 hr; flag UNDER-fueling if intake is below the lower bound, never over-consumption of sugar. Activity fueling calories DO count toward total daily energy balance, but never toward "diet quality" or macro-ratio assessments.
...
Activity fueling is reported separately from the regular diet under "Activity fueling". Do NOT critique its macro composition (high sugar, low protein, low fiber are expected and correct mid-effort) and do not lump fueling carbs/calories into macro-quality calls. Fueling targets: ~60 g/hr for moderate, 80–100 g/hr for hard >2 hr, 90–120 g/hr for race-pace >2.5 hr. Flag UNDER-fueling if intake is below the lower bound, never over-consumption of sugar. Fueling calories DO count toward total daily energy balance, but never toward diet quality.
...
Activity fueling is reported separately from the regular diet under "Activity fueling". Do NOT critique its macro composition (high sugar, low protein, low fiber are expected and correct mid-effort) and do not lump fueling carbs/calories into macro-quality calls or "imbalanced sugar" flags. Fueling targets: ~60 g/hr for moderate, 80–100 g/hr for hard >2 hr, 90–120 g/hr for race-pace >2.5 hr. Flag UNDER-fueling if intake is below the lower bound, never over-consumption of sugar. Fueling calories DO count toward total daily energy balance, but never toward diet quality or macro-ratio assessments.
...
Mid-activity fuel (gels, drink mix, chews, race-day bars) is NOT a meal — never suggest it as a breakfast/lunch/snack/dinner idea, and ignore the "Activity fueling" section when assessing what's already been eaten today for diet purposes (those carbs go to working muscle, not the user's macros).
...
Mid-activity fuel (gels, drink mix, chews, race-day bars) is NOT a meal — never suggest it as a meal idea, and ignore activity-fueling rows when deciding what gaps to fill in the diet.
...
Mid-activity fuel (gels, drink mix, chews) is not a meal — never suggest it.
